            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Data Seluruh All User</h3>
                        ...
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $a->created_at }}</td>
                                    <td>
                                        <a data-toggle="modal" id="infoAllUser" data-target="#modal-info{{$a->id}}"
                                            class="btn btn-info"><i class="fas fa-info-circle"></i></a>
                                        <a class="btn btn-success" data-toggle="modal" id="updatealluser"
                                            data-target="#modal-edit{{$a->id}}"><i class="fas fa-edit"></i></a>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route ('alluser.update', $a->id) }}" method="POST"
