            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Data Seluruh Teknisi</h3>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a data-toggle="modal" id="updateteknisi" data-target="#modal-edit{{$a->id}}" class="btn btn-success"><i class="fas fa-edit"></i></a>
                                        <form action="{{ route('teknisi.destroy', $a->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route ('teknisi.update', $a->id) }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
